...
for ci, (title, val, sub, bg) in enumerate(kpis, 1):
    ...
    ws.cell(row=9,  column=ci*2-1, value=title).font = Font(name='Calibri', size=8, bold=True, color='aaaaaa')
    ws.cell(row=9,  column=ci*2-1).fill = PatternFill('solid', fgColor=bg)
    ws.cell(row=10, column=ci*2-1, value=val).font = Font(name='Calibri', size=22, bold=True, color='FFFFFF')
    ws.cell(row=10, column=ci*2-1).fill = PatternFill('solid', fgColor=bg)
    ws.cell(row=11, column=ci*2-1, value=sub).font = Font(name='Calibri', size=8, color='cccccc')
